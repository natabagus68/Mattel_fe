...
import { useDeleteToyNumberMutation, useGetToysQuery } from '../../../../../app/services/ToysServices'
import moment from 'moment'

export default function useToyViewModel() {
    ...
    const [paramData, setParamData] = useState({
        ...
        sort: searchParam.get('sort') || 'Number_ASC',
    })

    const { data: responDataToys = { data: [] }, isLoading, refetch: refetchToys } = useGetToysQuery({ page: paramData.page, limit: 10, q: paramData.search, sort_val: paramData.sort.split('_')[1], table_name: paramData.sort.split('_')[0] })
    const [deleteToy, resultDelete] = useDeleteToyNumberMutation()

            ...
            <div className='py-6 px-8 rounded-[6px] flex flex-col gap-4 border border-[#D0D3D9] bg-[#FFF] text-[#313030]'>
                <div className='flex justify-between items-center'>
                    <div className='inline-flex flex-col'>
                        <span className='text-2xl font-bold'>Line Group</span>
                ...
                <div className='overflow-x-auto'>
                    <table className='w-full'>
                        <thead className='border-y border-y-[#D0D3D9] bg-[#FAFAFB]'>
                            ...
                            <th className='p-2 font-semibold text-sm text-[#667085] text-start'>Group Name</th>
                            <th className='p-2 font-semibold text-sm text-[#667085] text-start'>Actions</th>
                        </thead>
                        <tbody>
                            {
                                !master.isLoading ?
                                    master.responDataLineGroup?.data.length !== 0 ?
                                        master.responDataLineGroup?.data.map((item, i) => (
                ...
                <PaginationNew page={master.paramData.page} lastpage={master.responDataLineGroup?.total_page} onNext={master.onNextPage} onPrev={master.onPrevPage} />
            </div>
